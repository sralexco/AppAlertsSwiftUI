...
class DetailAlertMAViewModel: BaseViewModel {
    ...
    private var service: DetailAlertMAServiceProtocol
    
    init(service: DetailAlertMAServiceProtocol = DetailAlertMAService.shared) {
