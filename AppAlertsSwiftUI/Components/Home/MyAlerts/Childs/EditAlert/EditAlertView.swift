...
struct EditAlertView: View {
    ...
    @StateObject var VM = EditAlertViewModel()
    @State private var photoItem: PhotosPickerItem?
    var title = "Edit Alert"
        ...
        VStack(alignment: .leading) {
            ...
            VStack {
                ...
                FloatingTextFieldAlter(title: "Type", isError: $VM.selectedTypeError, content: {
                        TypePickerEAMenu(selectedType: $VM.selectedType, types: VM.types, selectedTypeError: VM.selectedTypeError) })
                    .padding(.init(top: 16, leading: 16, bottom: 0, trailing: 16 ))
                ...
                FloatingTextFieldAlter(title: "Image", isError: $VM.imageError, content: {
                        ImagePickerEAView(photoItem: $photoItem, VM: VM) })
                    .padding(.init(top: 10, leading: 16, bottom: 0, trailing: 16 ))
...
struct ImagePickerEAView: View {
    @Binding var photoItem: PhotosPickerItem?
    @ObservedObject var VM: EditAlertViewModel
