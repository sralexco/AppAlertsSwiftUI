...
class DetailAlertMViewModel: BaseViewModel {
    ...
    private var service: DetailAlertMServiceProtocol
    
    init(service: DetailAlertMServiceProtocol = DetailAlertMService.shared) {
